...
data RegisterForm =
  RegisterForm { regFormUsername :: Text, regFormPassword :: Text }
...
type LoginApi = "login" :> ReqBody '[JSON] LoginForm :> Post
    '[JSON]
    (Headers
       '[Header "Set-Cookie" SetCookie, Header "Set-Cookie" SetCookie]
       NoContent) :<|> "register" :> ReqBody '[JSON] RegisterForm :> Post
    '[JSON]
    (Headers
       '[Header "Set-Cookie" SetCookie, Header "Set-Cookie" SetCookie]
       NoContent)
